...
<xsl:stylesheet version="2.0" 
  ...
  <xsl:template name="siteindexTable">
    <h3>Este archivo de índice de sitemap fue creado por tureH.</h3>          
    <h2>Número de mapas de sitio en este índice de Sitemap Google: <xsl:value-of select="count(sitemap:sitemapindex/sitemap:sitemap)"></xsl:value-of></h2>          
    <p class="sml">Haga click en el titulo de cada tabla para cambiar el orden.</p>
    <table border="1" width="100%" class="data" id="table1">
      <tr class="header">
        <td>Sitemap URL</td>
        <td>Ultima modifacion</td>
      </tr>
  ...
  <xsl:template name="sitemapTable">          
    <h2>Numero de URL Google Sitemap: <xsl:value-of select="count(sitemap:urlset/sitemap:url)"></xsl:value-of></h2>
    <p class="sml">Haga click en el titulo de cada tabla para cambiar el orden.</p>
    <table border="1" width="100%" class="data" id="table0">
	  <tr class="header">
	    <td>Sitemap URL</td>
		<td>Ultima modificación</td>
		<td>Cambio de frec.</td>
		<td>Prioridad</td>
	  </tr>
